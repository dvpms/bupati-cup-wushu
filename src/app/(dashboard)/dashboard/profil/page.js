  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-purple-50 via-fuchsia-50 to-indigo-100 py-12 px-4 sm:px-6 lg:px-8 flex items-center justify-center">
      <div className="w-full max-w-xl bg-white rounded-2xl shadow-xl border border-purple-200 p-8 relative">
        ...
        <p className="text-center text-gray-500 mb-6">Informasi utama kontingen Anda</p>
            ...
            <>
              <div className="space-y-6">
                <div className="flex flex-col items-center gap-2">
                  <span className="block text-sm text-gray-500">Nama Kontingen</span>
                  <span className="block text-xl font-bold text-gray-900 tracking-tight">{kontingen.nama}</span>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="flex flex-col gap-1">
                    <span className="block text-sm text-gray-500">Kota</span>
                    <span className="block text-lg font-semibold text-gray-800">{kontingen.kota}</span>
                  </div>
                  <div className="flex flex-col gap-1">
                    <span className="block text-sm text-gray-500">Provinsi</span>
                    <span className="block text-lg font-semibold text-gray-800">{kontingen.provinsi}</span>
                  </div>
                </div>
                <div className="flex flex-col gap-1">
                  <span className="block text-sm text-gray-500">Manajer</span>
                  <span className="block text-lg font-semibold text-gray-800">{kontingen.manager}</span>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="flex flex-col gap-1">
                    <span className="block text-sm text-gray-500">WhatsApp</span>
                    <span className="block text-lg font-semibold text-gray-800">{kontingen.whatsapp}</span>
                  </div>
                  <div className="flex flex-col gap-1">
                    <span className="block text-sm text-gray-500">Email</span>
                    <span className="block text-lg font-semibold text-gray-800">{kontingen.email}</span>
                  </div>
                </div>
              </div>
          ...
          <form className="space-y-6" onSubmit={handleSave}>
            <div className="flex flex-col items-center gap-2">
              ...
              <input type="text" name="nama" value={form.nama} onChange={handleChange}
                className="block w-full max-w-xs rounded-lg border border-gray-300 px-3 py-2 text-lg font-bold text-gray-900 text-center focus:outline-none focus:ring-2 focus:ring-purple-400" required />
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="flex flex-col gap-1">
                <span className="block text-sm text-gray-500">Kota</span>
                <input type="text" name="kota" value={form.kota} onChange={handleChange}
                  className="block w-full rounded-lg border border-gray-300 px-3 py-2 text-lg font-semibold text-gray-800 focus:outline-none focus:ring-2 focus:ring-purple-400" required />
              </div>
              <div className="flex flex-col gap-1">
                <span className="block text-sm text-gray-500">Provinsi</span>
                <input type="text" name="provinsi" value={form.provinsi} onChange={handleChange}
                  className="block w-full rounded-lg border border-gray-300 px-3 py-2 text-lg font-semibold text-gray-800 focus:outline-none focus:ring-2 focus:ring-purple-400" required />
              </div>
            </div>
            <div className="flex flex-col gap-1">
              <span className="block text-sm text-gray-500">Manajer</span>
              <input type="text" name="manager" value={form.manager} onChange={handleChange}
                className="block w-full rounded-lg border border-gray-300 px-3 py-2 text-lg font-semibold text-gray-800 focus:outline-none focus:ring-2 focus:ring-purple-400" required />
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="flex flex-col gap-1">
